...
class Review(BaseModel):
    ...
    pros: Optional[list[str]] = Field(default = None, description="List the pros mentioned in the review inside a list. If no pros are mentioned, return an empty list")
    cons: Optional[list[str]] = Field(default = None, description="List the cons mentioned in the review inside a list. If no cons are mentioned, return an empty list")
    name: Optional[str] = Field(default = None, description="The name of the reviewer. If the review does not mention a name, return null")
